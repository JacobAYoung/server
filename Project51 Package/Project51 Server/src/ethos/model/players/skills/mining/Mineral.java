...
public enum Mineral {
			...
			COPPER(new int[] { 7484, 11961, 11960, 11962, 13709, 7453 }, "bronze", 1, 18, 5, 5, 15, 15000, true, generateExclusive(436)), 
	...
	CLAY(new int[] { 7487, 7454 }, "none", 1, 18, 0, 3, 15, 30000, true, generateExclusive(434)), 
	COPPER(new int[] { 7484, 11961, 11960, 11962, 13709 }, "bronze", 1, 18, 10, 5, 15, 15000, true, generateExclusive(436)), 
	...
	COAL(new int[] { 7489, 9717, 9718, 9719, 2096, 13714, 13706 }, "none", 30, 50, 6, 15, 29, 14600, true, generateExclusive(453)), 
	...
	MITHRIL(new int[] { 7492, 13718, 7459 }, "mithril", 55, 80, 6, 40, 35, 13800, true, generateExclusive(447)), 
	ADAMANT(new int[] { 7493, 13720, 7460 }, "adamant", 70, 95, 4, 50, 37, 13200, true, generateExclusive(449)), 
	RUNE(new int[] { 7494, 7461, 14175 }, "rune", 85, 125, 2, 100, 39, 12500, true, generateExclusive(451)), 
	ESSENCE(new int[] { 7471, 14912 }, "none", 30, 5, -1, -1, 20, 15000, false, generateExclusive(7936)),
	AMETHYST(new int[] { 30371, 30372 }, "none", 92, 140, 2, 100, 40, 11500, false, generateExclusive(21347)),			
	GEM(new int[] { 9030 }, "none", 40, 60, 20, 25, 20, 15000, true, new MineralReturn() {
				@Override
				public int generate() {
