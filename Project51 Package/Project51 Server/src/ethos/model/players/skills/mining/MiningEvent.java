...
public class MiningEvent extends Event<Player> {
	...
	public void execute() {
		...
		if (pieces == 1) { // Experience Calculation with 1 Prospector Pieces
			xpBoostReg = (mineral.getExperience() * Config.MINING_EXPERIENCE + mineral.getExperience() * Config.MINING_EXPERIENCE / 10) * .02;
			xpBoostOSRS = (mineral.getExperience() + mineral.getExperience() / 10) * .02;
		osrsExperience = (mineral.getExperience() + mineral.getExperience() / 10) + xpBoostOSRS;
		regExperience = (mineral.getExperience() * Config.MINING_EXPERIENCE + mineral.getExperience() * Config.MINING_EXPERIENCE / 10) + xpBoostReg;
		}
		if (pieces == 2) { // Experience Calculation with 2 Prospector Pieces
			xpBoostReg = (mineral.getExperience() * Config.MINING_EXPERIENCE + mineral.getExperience() * Config.MINING_EXPERIENCE / 10) * .04;
			xpBoostOSRS = (mineral.getExperience() + mineral.getExperience() / 10) * .04;
		osrsExperience = (mineral.getExperience() + mineral.getExperience() / 10) + xpBoostOSRS;
		regExperience = (mineral.getExperience() * Config.MINING_EXPERIENCE + mineral.getExperience() * Config.MINING_EXPERIENCE / 10) + xpBoostReg;
		}
		if (pieces == 3) { // Experience Calculation with 3 Prospector Pieces
			xpBoostReg = (mineral.getExperience() * Config.MINING_EXPERIENCE + mineral.getExperience() * Config.MINING_EXPERIENCE / 10) * .06;
			xpBoostOSRS = (mineral.getExperience() + mineral.getExperience() / 10) * .06;
		osrsExperience = (mineral.getExperience() + mineral.getExperience() / 10) + xpBoostOSRS;
		regExperience = (mineral.getExperience() * Config.MINING_EXPERIENCE + mineral.getExperience() * Config.MINING_EXPERIENCE / 10) + xpBoostReg;
		}
