...
public class FarmingHerb {
	...
	public enum Herb {
		...
		GUAM(5291, 199, 11, 13, 1, 50, 8000), //.50 mins - 30 seconds
		MARRENTIL(5292, 201, 14, 15, 7, 50, 7800),
		TARROMIN(5293, 203, 16, 18, 19, 50, 7600),
		HARRALANDER(5294, 205, 22, 24, 26, 50, 7400), 
		GOLPAR(20906, 20904, 22, 24, 27, 50, 7400), //Raids - Golpar - 30 seconds
		RANARR(5295, 207, 27, 31, 32, 125, 7200), // 1.25 mins - 75 seconds
		TOADFLAX(5296, 3049, 34, 39, 38, 125, 7000), 
		BUCHU(20909, 20907, 34, 39, 39, 50, 7000), // Raids - Buchu - 30 seconds
		IRIT(5297, 209, 43, 49, 44, 125, 6800), 
		AVANTOE(5298, 211, 55, 62, 50, 125, 6600),
		NOXIFER(20802, 20901, 55, 62, 55, 50, 6600), // Raids - Noxifer - 30 seconds
		KWUARM(5299, 213, 69, 78, 56, 125, 6400), 
		SNAP_DRAGON(5300, 3051, 88, 99, 62, 250, 6200), //2.5 mins - 150 seconds
		CADANTINE(5301, 215, 107, 120, 67, 250, 6000), 
		LANTADYME(5302, 2485, 135, 152, 73, 250, 5800), 
		DWARF_WEED(5303, 217, 171, 192, 79, 250, 5600), 
		TORSTOL(5304, 219, 200, 225, 85, 500, 5000); // 5 mins - 300 seconds
	...
	/*	GUAM(5291, 199, 100, 30, 1, 50, 8000), //.50 mins - 30 seconds
		...
		GOLPAR(20906, 20904, 500, 150, 27, 50, 7400), //Raids - Golpar - 30 seconds
		RANARR(5295, 207, 600, 200, 32, 125, 7200), // 1.25 mins - 75 seconds
		TOADFLAX(5296, 3049, 1000, 250, 38, 125, 7000),
		BUCHU(20909, 20907, 1000, 250, 39, 50, 7000), // Raids - Buchu - 30 seconds
		IRIT(5297, 209, 1250, 300, 44, 125, 6800), 
		AVANTOE(5298, 211, 1500, 350, 50, 125, 6600),
		NOXIFER(20802, 20901, 1500, 350, 55, 50, 6600), // Raids - Noxifer - 30 seconds
