	...
	public static void lightFire(final Player player, final int logUsed, final String usage) {
		...
		if (log.getlogId() == logUsed) {
			...
			if (pieces == 1) { // Experience Calculation with 1 Pyromancer Pieces
				xpBoostReg = (log.getExperience() * Config.FIREMAKING_EXPERIENCE + log.getExperience() * Config.FIREMAKING_EXPERIENCE / 10) * .02;
				xpBoostOSRS = (log.getExperience() + log.getExperience() / 10 * pieces) * .02;
			...
			xpBoostReg = (log.getExperience() * Config.FIREMAKING_EXPERIENCE + log.getExperience() * Config.FIREMAKING_EXPERIENCE / 10) * .04;
			xpBoostOSRS = (log.getExperience() + log.getExperience() / 10 * pieces) * .04;
			osrsExperience = (log.getExperience() + log.getExperience() / 10 * pieces) + xpBoostReg;
			regExperience = (log.getExperience() * Config.FIREMAKING_EXPERIENCE + log.getExperience() * Config.FIREMAKING_EXPERIENCE / 10) + xpBoostReg;
			}
			if (pieces == 3) { // Experience Calculation with 3 Pyromancer Pieces
				xpBoostReg = (log.getExperience() * Config.FIREMAKING_EXPERIENCE + log.getExperience() * Config.FIREMAKING_EXPERIENCE / 10) * .06;
				xpBoostOSRS = (log.getExperience() + log.getExperience() / 10 * pieces) * .06;
				osrsExperience = (log.getExperience() + log.getExperience() / 10 * pieces) + xpBoostReg;
			regExperience = (log.getExperience() * Config.FIREMAKING_EXPERIENCE + log.getExperience() * Config.FIREMAKING_EXPERIENCE / 10) + xpBoostReg;
			}
			if (pieces == 4) { // Experience Calculation with 4 Pyromancer Pieces
				xpBoostReg = (log.getExperience() * Config.FIREMAKING_EXPERIENCE + log.getExperience() * Config.FIREMAKING_EXPERIENCE / 10) * .1;
				xpBoostOSRS = (log.getExperience() + log.getExperience() / 10 * pieces) * .1;
			osrsExperience = (log.getExperience() + log.getExperience() / 10 * pieces) + xpBoostReg;
			regExperience = (log.getExperience() * Config.FIREMAKING_EXPERIENCE + log.getExperience() * Config.FIREMAKING_EXPERIENCE / 10) + xpBoostReg;
			}
			if (usage == "infernal_axe") {
