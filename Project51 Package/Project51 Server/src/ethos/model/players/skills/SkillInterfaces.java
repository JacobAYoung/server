...
public class SkillInterfaces {
	...
	public void rangedComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("60", "Craw's Bow", 22550, 9);
			menuLine("70", "Crystal Bow(With 50 Agility)", 4212, 10);
			menuLine("75", "Toxic Blowpipe", 12926, 11);
			...
			menuLine("60", "Dragon Dart", 11230, 27);
			menuLine("60", "Dragon Throwing Knife", 22804, 28);
	...
	public void prayerComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("55", "Preserve", 1714, 24);
			menuLine("60", "Chivalry", 1714, 25);
			menuLine("70", "Piety", 1714, 26);
			menuLine("74", "Rigour", 1714, 27);
			menuLine("77", "Augury", 1714, 28);
	...
	public void runecraftingComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("95", "Wrath runes", 21880, 19);
			...
			menuLine("89", "2 Blood runes per essence", 565, 26);
			...
			menuLine("95", "2 soul runes per essence", 566, 30);
			menuLine("96", "3 blood runes per essence", 565, 31);
			menuLine("98", "8 Mind runes per essence", 558, 32);
			menuLine("99", "10 Air runes per essence", 556, 33);
			menuLine("99", "3 Soul runes per essence", 566, 33);
			...
			menuLine("50", "Large Pouch(9 Essence)", 6819, 2);
	...
	public void herbloreComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("87", "Anti-venom \\n Antidote++ (4 dose), 15 Zulrah scales", 12905, 26);
			menuLine("90", "Super Combat \\n Torstol potion (unf), 1 x super attack, strength\\nand defence potion", 12695, 27);
			menuLine("94", "Anti-venom + \\n Anti-venom (4 dose), Torstol potion (unf)", 12913, 28);
			optionTab("Herblore", "Potions", "Potions", "Herbs", "Raids", "Milestones", "", "", "", "", "", "", "", "", "");
		}
			...
			optionTab("Herblore", "Herbs", "Potions", "Herbs", "Raids", "Milestones", "", "", "", "", "", "", "", "", "");
		}
		else if (screen == 3) {
			clearMenu();
			menuLine("59", "Elder \\n Golpar, Stinkhorn Mushroom", 20920, 0);
			menuLine("59", "Twisted \\n Golpar, Cicely", 20932, 1);
			menuLine("59", "Kodai \\n Golpar, Endarkened Juice", 20944, 2);
			menuLine("65", "Revitalisation \\n Buchu leaf, Sinkhorn Mushroom", 20956, 3);
			menuLine("65", "Prayer Enhance \\n Buchu leaf, Cicely", 20968, 4);
			 menuLine("65", "Xeric's Aid \\n Buchu leaf, Endarkened Juice", 20980, 5);
			menuLine("75", "Overload \\n Noxifer, Elder, Twisted, Kodai potions", 20992, 6);
			optionTab("Herblore", "Potions", "Potions", "Herbs", "Raids", "Milestones", "", "", "", "", "", "", "", "", "");
	}
		else if (screen == 4) {
			clearMenu();
			menuLine("99", "Skill Mastery", c.getItems().skillcapes[c.playerHerblore][0], 0);
			optionTab("Herblore", "Milestones", "Potions", "Herbs", "Raids", "Milestones", "", "", "", "", "", "", "", "", "");
		}
	...
	public void fishingComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("79", "Sea Turtle - Net Fishing", 395, 23);
			menuLine("81", "Manta Ray - Net fishing", 389, 24);
			menuLine("82", "Anglerfish - Bait fishing(Sandworms)", 13439, 25);
			menuLine("85", "Dark Crab - Cage fishing(Dakr bait)", 11934, 26);
	...
	public void cookingComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("84", "Anglerfish", 13439, 33);
			menuLine("90", "Dark Crab", 11934, 34);
	...
	public void woodcuttingComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("90", "Redwood Tree", 19669, 13);
