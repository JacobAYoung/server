...
public class PotionData {
	...
	public enum FinishedPotions {
		...
		ANTI_VENOM_PLUS(new GameItem(12913), 94, 125, new GameItem(12905), new GameItem(111)), 
		...
		EXTENDED_ANTIFIRE(new GameItem(11951), 84, 175, new GameItem(2452), new GameItem(11994, 4)), 
		SUPER_ANTIFIRE(new GameItem(21978), 92, 220, new GameItem(2452), new GameItem(21977)),
		...
		WEAPON_POISON_PLUS(new GameItem(5937), 73, 165, new GameItem(5935), new GameItem(6016), new GameItem(223)), 
		...
		REVITALISATION(new GameItem(20956), 65, 180, new GameItem(20801), new GameItem(20908), new GameItem(20910)),
		XERICS_AID(new GameItem(20980), 65, 180, new GameItem(20801), new GameItem(20908), new GameItem(20911)),
		PRAYER_ENHANCE(new GameItem(20968), 65, 180, new GameItem(20801), new GameItem(20908), new GameItem(20912)),
		TWISTED_POTION(new GameItem(20932), 59, 130, new GameItem(20801), new GameItem(20905), new GameItem(20912)),
		ELDER_POTION(new GameItem(20920), 59, 130, new GameItem(20801), new GameItem(20905), new GameItem(20910)),
		KODAI_POTION(new GameItem(20944), 59, 130, new GameItem(20801), new GameItem(20905), new GameItem(20911)),
		OVERLOAD(new GameItem(20992), 75, 210, new GameItem(20902), new GameItem(20920), new GameItem(20932), new GameItem(20944));
