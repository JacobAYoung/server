...
public enum Potion {
	...
	REVITALISATION(new GameItem(20956), 65, 180, new GameItem(20908), new GameItem(20910)),
	XERICS_AID(new GameItem(20980), 65, 180, new GameItem(20908), new GameItem(20911)),
	PRAYER_ENHANCE(new GameItem(20968), 65, 180, new GameItem(20908), new GameItem(20912)),
	TWISTED_POTION(new GameItem(20932), 59, 130, new GameItem(20905), new GameItem(20912)),
	ELDER_POTION(new GameItem(20920), 59, 130, new GameItem(20905), new GameItem(20910)),
	KODAI_POTION(new GameItem(20944), 59, 130, new GameItem(20905), new GameItem(20911)),
