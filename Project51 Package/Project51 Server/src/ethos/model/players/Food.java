...
public class Food {
	...
	public static enum FoodToEat {
		...
		//start of raids fish
		PYSK(20856, 5, "Pysk Fish (0)", 0, "Food", false),
		SUPHI(20858, 8, "Suphi Fish (1)", 0, "Food", false),
		LECKISH(20860, 11, "Leckish Fish (2)", 0, "Food", false),
		BRAWK(20862, 14, "Brawk Fish (3)", 0, "Food", false),
		MYCIL(20864, 17, "Mycil Fish (4)", 0, "Food", false),
		ROQED(20866, 20, "Roqed Fish (5)", 0, "Food", false),
		KYREN(20868, 23, "Kyren Fish (6)", 0, "Food", false);
	...
	public void eat(int id, int slot) {
		...
		if ((System.currentTimeMillis() - c.foodDelay >= 1750 || eatingKarambwam) && c.getHealth().getAmount() > 0) {
			...
			Achievements.increase(c, AchievementType.HEAL_WITH_FOOD, f.getHeal());
			//c.sendMessage("increasing "+ f.getHeal() +"");
		}
	}
