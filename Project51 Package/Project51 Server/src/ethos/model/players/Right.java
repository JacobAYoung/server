...
public enum Right implements Comparator<Right> {
	...
	MODERATOR(1, "00FFFF", "Moderator", HELPER),
	ADMINISTRATOR(2, "F5FF0F", "Administrator", MODERATOR),
	OWNER(3, "9400D3", "Owner", ADMINISTRATOR),
	UNKNOWN(4, "F5FF0F", ""),
	...
	public static final Right[] PRIORITY = { PLAYER, OSRS, IRONMAN, ULTIMATE_IRONMAN, HARDCORE, CONTRIBUTOR, SPONSOR, SUPPORTER, DONATOR, SUPER_DONATOR, EXTREME_DONATOR, LEGENDARY, RESPECTED_MEMBER, HITBOX, YOUTUBER, HELPER,
