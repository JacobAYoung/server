...
public class Boundary {
	...
	public static final Boundary[] PURSUIT_AREAS  = { ALTAR, FORTRESS, DEMONIC, ROGUES, DRAGONS, GALVEK_1, GALVEK_2, GALVEK_3 };
...
//public static final Boundary WILDERNESS = new Boundary(1486, 1444, 3767, 3730);
	...
	public static final Boundary DONATOR_ZONE = new Boundary(1975, 2809, 2177, 2883);
	 ...
	 */
	public static final Boundary[] HARDCORESAFEZONE = { FIGHT_CAVE, RAIDS, INFERNO, OLM, RFD, LIGHTHOUSE, SKOTIZO_BOSSROOM, ZULRAH, VORKATH, WITHIN_BOUNDARY_CERB};
}