...
public class PlayerAssistant {
	...
	public void levelUp(int skill) {
		...
		if (c.maxRequirements(c) && !c.getRights().isOrInherits(Right.OWNER) && !c.getRights().isOrInherits(Right.ADMINISTRATOR)) {
			PlayerHandler
	...
	public boolean addSkillXP(int amount, int skill, boolean dropExperience) {
		...
		Skill s = Skill.forId(skill);
		PlayerHandler.executeGlobalMessage("<img=10></img>[<col=255>News</col>] <col=CC0000>" + Misc.capitalize(c.playerName) + "</col> has reached 100M XP in <col=CC0000>"
		...
		Skill s = Skill.forId(skill);
		PlayerHandler.executeGlobalMessage("<img=10></img>[<col=255>News</col>] <col=CC0000>" + Misc.capitalize(c.playerName) + "</col> has reached 150M XP in <col=CC0000>"
				+ s.toString() + "</col>, congratulations.");
...
*/
	...
	public void addStarter() {
		...
		DiscordMessager.sendNewPlayers("[New Player Alert]The new player " + Misc.capitalizeJustFirst(c.playerName) + " noteitem! Everyone give him a warm welcome when you see him!");
		...
		//}
			...
			c.getItems().wearItem(1712, 1, c.playerAmulet);
