    ...
    public void processPacket(Player c, int packetType, int packetSize) {
       ...
       /* if (playerCommand.equals("ge")) {
        ...
        if (playerCommand.startsWith("highscores")) {
            ...
            c.getPA().sendFrame126("http://YOURLINKHERE.everythingrs.com/services/hiscores", 12000);
        }
        
        if (playerCommand.startsWith("donate")) {

            c.getPA().sendFrame126("http://YOURLINKHERE.everythingrs.com/services/store", 12000);
        }
        ...
        if (playerCommand.startsWith("spawns") && c.playerName.equalsIgnoreCase("KID BUU")) {
