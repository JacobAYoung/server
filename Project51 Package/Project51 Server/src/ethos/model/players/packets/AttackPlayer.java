...
public class AttackPlayer implements PacketType {
	...
	public void processPacket(Player player, int packetType, int packetSize) {
		...
		case ATTACK_PLAYER:
			...
			if (!usingCross && !usingArrows && usingBow && player.playerEquipment[player.playerWeapon] == 22550 && player.playerEquipment[player.playerWeapon] < 4212 && player.playerEquipment[player.playerWeapon] > 4223) {
