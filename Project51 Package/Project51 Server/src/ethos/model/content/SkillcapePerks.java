...
public enum SkillcapePerks {
	...
	public static void mixCape(Player player, String cape) {
		...
		case "SARADOMINI":
			...
			player.getDH().sendItemStatement("You've combined the Imbued saradomin cape and max cape", 13329);
			break;
		...
		case "ZAMORAKI":
			...
			player.getDH().sendItemStatement("You've combined the Imbued Zamorak cape and max cape", 13329);
			break;
		...
		case "GUTHIXI":
			...
			player.getDH().sendItemStatement("You've combined the Imbued Guthix cape and max cape", 13329);
			break;
