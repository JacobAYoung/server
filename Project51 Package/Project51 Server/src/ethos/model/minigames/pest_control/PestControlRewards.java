...
public class PestControlRewards {
	...
	public enum RewardButton {
				...
				VOID_MACE(144198, 0, 280, new ItemReward(125, new GameItem(8841))), 
				VOID_KNIGHT_ROBE(144201, 0, 320, new ItemReward(150, new GameItem(8840))), 
				VOID_MAGE_HELM(144204, 0, 360, new ItemReward(125, new GameItem(11663))), 
				VOID_MELEE_HELM(144207, 0, 400, new ItemReward(125, new GameItem(11665))), 
				VOID_KNIGHT_TOP(144210, 210, 280, new ItemReward(150, new GameItem(8839))), 
				VOID_KNIGHT_GLOVES(144213, 210, 320, new ItemReward(100, new GameItem(8842))), 
				VOID_RANGE_HELM(144216, 210, 360, new ItemReward(125, new GameItem(11664))), 
				FIGHTER_TORSO(144219, 210, 400, new ItemReward(275, new GameItem(10551))), 
				BARROWS_GLOVES(144222, 0, 440, new ItemReward(35, new GameItem(7462))), 
				FIGHTER_HAT(144225, 210, 440, new ItemReward(50, new GameItem(10548))
		);
