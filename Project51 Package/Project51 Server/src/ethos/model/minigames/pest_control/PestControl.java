				...
				if (gameMembers.get(i) != null) {
					if (Boundary.isIn(gameMembers.get(i), GAME_BOUNDARY)) {
						...
						if (player.pestControlDamage > MINIMUM_DAMAGE) {
							...
							int point_reward = DoubleMinigames.isDoubleMinigames() && Config.BONUS_MINIGAME_WOGW ? 15 :
											   !DoubleMinigames.isDoubleMinigames() && Config.BONUS_MINIGAME_WOGW ? 10 : 
												   DoubleMinigames.isDoubleMinigames() && !Config.BONUS_MINIGAME_WOGW ? 10 : POINT_REWARD;
